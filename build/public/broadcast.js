...
document.addEventListener("DOMContentLoaded", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const audioOnIcon = `
            ...
            `;
    toggleVideoButton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
        const videoTrack = yield toggleVideo();
        if (videoTrack) {
    ...
    toggleAudioButton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
        const audioTrack = yield toggleAudio();
        if (audioTrack) {
            audioEnabled = !audioEnabled;
            audioTrack.enabled = audioEnabled;
            toggleAudioButton.innerHTML = audioEnabled ? audioOnIcon : audioOffIcon;
            toggleAudioButton.classList.toggle('disabled');
            // toggleAudioButton.classList.toggle('muted', !audioEnabled);
            // updateAudioIcon(audioEnabled);
        }
    }));
